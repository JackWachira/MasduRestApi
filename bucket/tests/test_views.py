...
class BucketListViewTestCase(APITestCase):
    ...
    def test_all_bucketlists_querying(self):
        ...
        self.assertEqual('Travel', bucketlists.data[0]['name'])
    ...
    def test_bucketlists_querying_by_id(self):
        ...
        bucketlist = self.client.get('/api/bucketlists/1/',
                                     format='json')
    ...
    def test_bucketlist_updating(self):
        ...
        update_response = self.client.put('/api/bucketlists/1/',
                                          {'name': 'Skii'}, format='json')

        self.assertEqual(update_response.status_code, 200)
        self.assertEqual('Skii', update_response.data['name'])
...
class BucketListItemViewTestCase(APITestCase):
    ...
    def test_creating_bucketlist_item(self):
        ...
        item_creation_response = \
            self.client.post('/api/bucketlists/1/items/',
                             {'name': 'Beach Tour'}, format='json')

        self.assertEqual(item_creation_response.status_code, 201)
        self.assertEqual('Beach Tour',
                         item_creation_response.data['name'])
    ...
    def test_updating_bucketlist_item(self):
        ...
        item_updating_response = \
            self.client.put('/api/bucketlists/1/items/1/',
    ...
    def test_deleting_bucketlist_item(self):
        ...
        item_deletion_response = \
            self.client.delete('/api/bucketlists/1/items/1/')
